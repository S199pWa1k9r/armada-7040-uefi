/** @file
 *
 *  Static SMBIOS Table for the GlobalScale Armada 7040 MochaBin
 ...
 *
 *  Copyright (c) 2022 Sleep Walker <s119p.wa1k9r@gmail.com>
...
CHAR8 *mOemStringsType11Strings[] = {
  "https://wiki.radxa.com/Rock3/CM3Plus",
  NULL
};
  ...
  )
{
  ...
  AsciiStrCpyS (mSysInfoManufName, sizeof (mSysInfoManufName), "GlobalScale");
  ...
  )
{
  ...
  mMemArrMapInfoType19.EndingAddress = mMemArrMapInfoType19.StartingAddress + mMemorySize / 1024 - 1;
